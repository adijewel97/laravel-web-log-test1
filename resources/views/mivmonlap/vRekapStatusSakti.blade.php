...
<script type="text/javascript">
        ...
        function tampilmydatatable(listdata) {
            ...
            $('#mytable').DataTable({
                ...
                drawCallback: function(row, data, start, end, display) {
                    ...
                    // Menampilkan hasil dan rata kanan
                    $('#tJML').html($.fn.dataTable.render.number('.', ',', 0).display(tJML))
                        .css('padding-right', '9px');
                    $('#tRPTAG').html($.fn.dataTable.render.number('.', ',', 0).display(tRPTAG))
                        .css('padding-right', '9px');
                }
            });
        }
    ...
    function formatRupiah(angka) {
        if (!angka) return 'Rp 0'; // Jika data null atau undefined, kembalikan Rp 0
